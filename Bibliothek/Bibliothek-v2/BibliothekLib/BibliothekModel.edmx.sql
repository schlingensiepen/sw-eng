...
-- --------------------------------------------------
-- Date Created: 04/21/2017 16:08:11
-- Generated from EDMX file: F:\dev\svn\sweng\prj\Demo\SS2017\main\cns\src\Bibliothek\BibliothekLib\BibliothekModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_UserMedia]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[MediaSet] DROP CONSTRAINT [FK_UserMedia];
GO
