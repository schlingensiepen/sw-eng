    ...
    public class BorrowController : Controller
    {
        ...
        public ActionResult Index(int? userId)
        {
            ...
            var media = (userId == null)
                ? db.Media.Include(m => m.Work).Include(m => m.User)
                : db.Media.Where(m => m.User.Id ==userId)
        ...
        public ActionResult Borrow(int? id, int? userId)
        {
            if (!setUser()) return new HttpStatusCodeResult(HttpStatusCode.Unauthorized);
            if (id == null)
            {
        ...
        public ActionResult Return(int? id)
        {
            ...
            if (media.User != LoggedInUser && !LoggedInUser.RoleStaff)
            {
        ...
        public ActionResult SelectMedia(int? userId)
        {
            ...
            return View(db.Media.Where(m=>m.User==null).ToList());
        }
