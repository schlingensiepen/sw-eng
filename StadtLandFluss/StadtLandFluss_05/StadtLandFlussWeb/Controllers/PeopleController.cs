...
namespace StadtLandFlussWeb.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            var people = db.People.Include(p => p.GeborenIn);
        ...
        {
            ViewBag.GeborenInId = new SelectList(db.NamedObjects, "Id", "Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Vorname,Familienname,GeborenInId")] Person person)
        {
